$( document ).ready(function() {
  ...
  $('#btnAdd').on('click', function (e) {
    ...
    <div class="form-group">
    <input type="text" class="form-control" name="item_amount[]" value="<?= set_value('item_amount'); ?>" />
    ...
    <td class="unit-price">
    <div class="form-group">
    <input type="text" class="form-control" name="unit_price[]" value="<?= set_value('unit_price'); ?>" />
